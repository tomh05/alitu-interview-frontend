...
export default function Episodes() {
  ...
  return (
    <Page>
      ...
      <Button mb="25px" color="white" bg="green.300" _hover={{ bg: 'green.200' }} rightIcon={<AddIcon w={3.5} h={3.5} />}>
        Add new episode
      </Button>
  ...
  return (
    <Flex justifyContent="space-between" alignItems="center" bg="gray.200" p="25px 40px" rounded={4} maxWidth="100%">
      <Flex direction="column">
        <Text as="p" fontSize="2xl" color="gray.600" textAlign="left">{episode.name}</Text>
        <Text as="p" fontSize="md" color="gray.800" textAlign="left">{episode.description}</Text>
      </Flex>
      <Button
        bg="purple.300"
        color="white"
